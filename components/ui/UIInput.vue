<template>
  <div class="box-border flex items-center flex-gap-1 b-1 b-primary-100 rounded-2 b-solid bg-white p-x-2 p-y-1.5 text-4.5 text-primary-700 transition hover:cursor-text focus-within:bg-primary-50" @mousedown="onClick">
