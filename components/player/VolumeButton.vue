  ...
  <HeadlessPopover class="relative">
    <Transition name="slide-fade">
      <HeadlessPopoverPanel class="z-7 absolute bottom-100% left-50% -translate-x-50% m-b-1">
        <div ref="railRef" class="flex flex-col-reverse h-22 w-10 rounded-3 bg-primary-50 shadow-inset shadow shadow-amber-100 cursor-pointer overflow-hidden" @mousedown="onMouseDown" @touchstart="onMouseDown">
